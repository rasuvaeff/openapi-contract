...
ссылка на них — локальный `{$ref: '#/$defs/…'}`, несущий `type` цели; схема,
с которой цикл начинается, инлайнится там, где встречена впервые, и заодно
сохраняется как def. У схемы без цикла `$defs` нет. Цикл ссылок вне схемы —
Path Item или Response, доходящий до самого себя, — отвергается, как и цикл,
в котором нет ни одной схемы.
